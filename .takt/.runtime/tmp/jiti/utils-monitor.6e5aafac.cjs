"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.ConnectionMonitor = void 0;var _nodeEvents = require("node:events");
class ConnectionMonitor extends _nodeEvents.EventEmitter {
  metrics = {
    latency: 0,
    uptime: 0,
    reconnects: 0,
...
}exports.ConnectionMonitor = ConnectionMonitor; /* v9-93091c4aaa65d66c */
