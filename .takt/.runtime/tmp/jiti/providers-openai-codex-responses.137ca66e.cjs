"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.streamSimpleOpenAICodexResponses = exports.streamOpenAICodexResponses = void 0;
...
var _simpleOptions = require("./simple-options.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);} // NEVER convert to top-level import - breaks browser/Vite builds (web-ui)
let _os = null;if (typeof process !== "undefined" && (process.versions?.node || process.versions?.bun)) {Promise.resolve().then(() => jitiImport("node:os").then((m) => _interopRequireWildcard(m))).then((m) => {_os = m;});} // ============================================================================
// Configuration
// ============================================================================
...
const streamOpenAICodexResponses = (model, context, options) => {
  ...
  return stream;
};exports.streamOpenAICodexResponses = streamOpenAICodexResponses;
...
// Request Building
// ============================================================================
exports.streamSimpleOpenAICodexResponses = streamSimpleOpenAICodexResponses;function buildRequestBody(model, context, options) {
  const messages = (0, _openaiResponsesShared.convertResponsesMessages)(model, context, CODEX_TOOL_CALL_PROVIDERS, {
  ...
  if (context.tools) {
    body.tools = (0, _openaiResponsesShared.convertResponsesTools)(context.tools, { strict: null });
  }
...
async function processStream(response, output, stream, model) {
  await (0, _openaiResponsesShared.processResponsesStream)(mapCodexEvents(parseSSE(response)), output, stream, model);
}
