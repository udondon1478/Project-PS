"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.GuildMember = void 0;var _v = require("discord-api-types/v10");
var _Base = require("../abstracts/Base.js");
var _permissions = require("../permissions.js");
var _index = require("../utils/index.js");
var _Role = require("./Role.js");
var _User = require("./User.js");
class GuildMember extends _Base.Base {
  constructor(client, rawData, guild) {
    super(client);
    this._rawData = rawData;
    this.guild = guild;
    this.user = new _User.User(client, rawData.user);
  ...
  get avatarUrl() {
    ...
    if (!this.user)
    return null;
    return (0, _index.buildCDNUrl)(`https://cdn.discordapp.com/guilds/${this.guild.id}/users/${this.user.id}/avatars`, this.avatar);
  }
  /**
  ...
  getAvatarUrl(options) {
    ...
    if (!this.user)
    return null;
    return (0, _index.buildCDNUrl)(`https://cdn.discordapp.com/guilds/${this.guild.id}/users/${this.user.id}/avatars`, this.avatar, options);
  }
  /**
  ...
  get roles() {
    ...
    return roles.map((role) => new _Role.Role(this.client, role, this.guild.id));
  }
  /**
  ...
  async getPermissions() {
    ...
    return _permissions.maxPermissions;
  ...
  async fetch() {
    const newData = await this.client.rest.get(_v.Routes.guildMember(this.guild.id, this.user.id));
    if (!newData)
    throw new Error(`Member ${this.user.id} not found`);
    this.setData(newData);
    return this;
  }
}exports.GuildMember = GuildMember; /* v9-d80306482aab8666 */
