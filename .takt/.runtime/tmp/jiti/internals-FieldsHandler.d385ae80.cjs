"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.FieldsHandler = void 0;var _v = require("discord-api-types/v10");
 ...
 */
class FieldsHandler extends _Base.Base {
  /**
  ...
  constructor(client, interaction) {
    ...
    interaction.data.components.forEach((component) => {
      if (component.type === _v.ComponentType.Label) {
        const subComponent = component.component;
        if (subComponent.type === _v.ComponentType.TextInput) {
  ...
  getUserSelect(key, required = false) {
    ...
    map((user) => new _index.User(this.client, user));
  }
  getRoleSelect(key, required = false) {
    ...
    map((role) => new _index.Role(this.client, role, guildId));
  }
...
}exports.FieldsHandler = FieldsHandler; /* v9-342724c957982b9e */
