"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.COMMAND_ARG_FORMATTERS = void 0;function normalizeArgValue(value) {
  if (value == null) {
    return undefined;
  }
  let text;
...
const COMMAND_ARG_FORMATTERS = exports.COMMAND_ARG_FORMATTERS = {
