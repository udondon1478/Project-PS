"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.extractAssistantText = extractAssistantText;exports.extractAssistantThinking = extractAssistantThinking;exports.extractThinkingFromTaggedStream = extractThinkingFromTaggedStream;exports.extractThinkingFromTaggedText = extractThinkingFromTaggedText;exports.formatReasoningMessage = formatReasoningMessage;exports.inferToolMetaFromArgs = inferToolMetaFromArgs;exports.promoteThinkingTagsToBlocks = promoteThinkingTagsToBlocks;exports.splitThinkingTaggedText = splitThinkingTaggedText;exports.stripDowngradedToolCallText = stripDowngradedToolCallText;exports.stripMinimaxToolCallXml = stripMinimaxToolCallXml;exports.stripThinkingTagsFromText = stripThinkingTagsFromText;var _reasoningTags = require("../shared/text/reasoning-tags.js");
var _piEmbeddedHelpers = require("./pi-embedded-helpers.js");
var _toolDisplay = require("./tool-display.js");
/**
...
function stripThinkingTagsFromText(text) {
  return (0, _reasoningTags.stripReasoningTagsFromText)(text, { mode: "strict", trim: "both" });
}
function extractAssistantText(msg) {
  ...
  return (0, _piEmbeddedHelpers.sanitizeUserFacingText)(extracted);
}
...
function inferToolMetaFromArgs(toolName, args) {
  const display = (0, _toolDisplay.resolveToolDisplay)({ name: toolName, args });
  return (0, _toolDisplay.formatToolDetail)(display);
} /* v9-3b8912661192004c */
