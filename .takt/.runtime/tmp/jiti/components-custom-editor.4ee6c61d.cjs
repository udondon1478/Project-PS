"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.CustomEditor = void 0;var _piTui = require("@mariozechner/pi-tui");
/**
 * Custom editor that handles app-level keybindings for coding-agent.
 */
class CustomEditor extends _piTui.Editor {
  keybindings;
...
}exports.CustomEditor = CustomEditor; /* v9-22aa819fe7fabfb7 */
