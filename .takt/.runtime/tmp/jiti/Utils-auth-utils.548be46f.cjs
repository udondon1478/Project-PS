"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.initAuthCreds = exports.addTransactionCapability = void 0;exports.makeCacheableSignalKeyStore = makeCacheableSignalKeyStore;var _nodeCache = _interopRequireDefault(require("@cacheable/node-cache"));
...
var _preKeyManager = require("./pre-key-manager.js");function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}
/**
...
function makeCacheableSignalKeyStore(store, logger, _cache) {
  ...
  new _nodeCache.default({
    stdTTL: _index.DEFAULT_CACHE_TTLS.SIGNAL_STORE, // 5 minutes
    useClones: false,
    deleteOnExpire: true
  });
...
const addTransactionCapability = (state, logger, { maxCommitRetries, delayBetweenTriesMs }) => {
  ...
  function getQueue(key) {
    if (!keyQueues.has(key)) {
      keyQueues.set(key, new _pQueue.default({ concurrency: 1 }));
    }
...
};exports.initAuthCreds = initAuthCreds; /* v9-d40a0c971dd889c2 */
