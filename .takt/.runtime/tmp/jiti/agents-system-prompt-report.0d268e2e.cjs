"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.buildSystemPromptReport = buildSystemPromptReport;function extractBetween(input, startMarker, endMarker) {
