"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.LEGACY_CONFIG_RULES = void 0;const LEGACY_CONFIG_RULES = exports.LEGACY_CONFIG_RULES = [
{
  path: ["whatsapp"],
