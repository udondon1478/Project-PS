"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.isValidCloudCodeAssistToolId = isValidCloudCodeAssistToolId;exports.sanitizeToolCallId = sanitizeToolCallId;exports.sanitizeToolCallIdsForCloudCodeAssist = sanitizeToolCallIdsForCloudCodeAssist;var _nodeCrypto = require("node:crypto");
const STRICT9_LEN = 9;
/**
...
function isValidCloudCodeAssistToolId(id, mode = "strict") {
  if (!id || typeof id !== "string") {
    return false;
  }
  if (mode === "strict9") {
