"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.makeCommunitiesSocket = exports.extractCommunityMetadata = void 0;var _index = require("../../WAProto/index.js");
var _index2 = require("../Types/index.js");
var _index3 = require("../Utils/index.js");
var _logger = _interopRequireDefault(require("../Utils/logger.js"));
var _index4 = require("../WABinary/index.js");
var _business = require("./business.js");function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}
const makeCommunitiesSocket = (config) => {
  ...
  async function parseGroupResult(node) {
    _logger.default.info({ node }, 'parseGroupResult');
    const groupNode = (0, _index4.getBinaryNodeChild)(node, 'group');
    if (groupNode) {
      try {
        _logger.default.info({ groupNode }, 'groupNode');
  ...
  return {
    ...
    communityUpdateDescription: async (jid, description) => {
      ...
      await communityQuery(jid, 'set', [
      {
        tag: 'description',
        attrs: {
          ...(description ? { id: (0, _index3.generateMessageID)() } : { delete: 'true' }),
          ...(prev ? { prev } : {})
        },
...
const extractCommunityMetadata = (result) => {
  ...
  community.attrs.id :
  (0, _index4.jidEncode)(community.attrs.id || '', 'g.us');
  ...
  const metadata = {
    ...
    memberAddMode,
    participants: (0, _index4.getBinaryNodeChildren)(community, 'participant').map(({ attrs }) => {
      return {
  ...
  return metadata;
};exports.extractCommunityMetadata = extractCommunityMetadata; /* v9-5abbac85d3e4d1a0 */
