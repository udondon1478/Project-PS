"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.VENICE_MODEL_CATALOG = exports.VENICE_DEFAULT_MODEL_REF = exports.VENICE_DEFAULT_MODEL_ID = exports.VENICE_DEFAULT_COST = exports.VENICE_BASE_URL = void 0;exports.buildVeniceModelDefinition = buildVeniceModelDefinition;exports.discoverVeniceModels = discoverVeniceModels;const VENICE_BASE_URL = exports.VENICE_BASE_URL = "https://api.venice.ai/api/v1";
const VENICE_DEFAULT_MODEL_ID = exports.VENICE_DEFAULT_MODEL_ID = "llama-3.3-70b";
const VENICE_DEFAULT_MODEL_REF = exports.VENICE_DEFAULT_MODEL_REF = `venice/${VENICE_DEFAULT_MODEL_ID}`;
// Venice uses credit-based pricing, not per-token costs.
// Set to 0 as costs vary by model and account type.
const VENICE_DEFAULT_COST = exports.VENICE_DEFAULT_COST = {
  input: 0,
  output: 0,
  cacheRead: 0,
  cacheWrite: 0
 ...
 */
const VENICE_MODEL_CATALOG = exports.VENICE_MODEL_CATALOG = [
// ============================================
