"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.BaseGuildTextChannel = void 0;var _v = require("discord-api-types/v10");
var _GuildThreadChannel = require("../structures/GuildThreadChannel.js");
var _Message = require("../structures/Message.js");
var _BaseGuildChannel = require("./BaseGuildChannel.js");
class BaseGuildTextChannel extends _BaseGuildChannel.BaseGuildChannel {
  /**
  ...
  async getChannelPins(options) {
    ...
    const result = await this.client.rest.get(_v.Routes.channelMessagesPins(this.id), Object.keys(queryParams).length > 0 ? queryParams : undefined);
    return {
      pins: result.items.map((pin) => ({
        pinnedAt: pin.pinned_at,
        message: new _Message.Message(this.client, pin.message)
      })),
  ...
  async startThread(data) {
    const thread = await this.client.rest.post(_v.Routes.threads(this.id), {
      body: { ...data }
    });
    return new _GuildThreadChannel.GuildThreadChannel(this.client, thread);
  }
}exports.BaseGuildTextChannel = BaseGuildTextChannel; /* v9-2ce4b5997245c934 */
