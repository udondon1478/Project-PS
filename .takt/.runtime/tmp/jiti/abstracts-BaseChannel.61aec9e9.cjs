"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.BaseChannel = void 0;var _v = require("discord-api-types/v10");
var _Base = require("./Base.js");
class BaseChannel extends _Base.Base {
   ...
   */
  async fetch() {
    const newData = await this.client.rest.get(_v.Routes.channel(this.id));
    if (!newData)
   ...
   */
  async delete() {
    await this.client.rest.delete(_v.Routes.channel(this.id));
  }
  /**
...
}exports.BaseChannel = BaseChannel; /* v9-0db1c236cdc6fa27 */
