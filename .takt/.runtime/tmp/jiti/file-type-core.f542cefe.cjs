"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.FileTypeParser = void 0;exports.fileTypeFromBlob = fileTypeFromBlob;exports.fileTypeFromBuffer = fileTypeFromBuffer;exports.fileTypeFromStream = fileTypeFromStream;exports.fileTypeFromTokenizer = fileTypeFromTokenizer;exports.fileTypeStream = fileTypeStream;exports.supportedMimeTypes = exports.supportedExtensions = exports.reasonableDetectionSizeInBytes = void 0;



var Token = _interopRequireWildcard(require("token-types"));
var strtok3 = _interopRequireWildcard(require("strtok3/core"));
var _inflate = require("@tokenizer/inflate");
...
var _supported = require("./supported.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);} /**
...
class FileTypeParser {
  ...
  checkString(header, options) {
    return this.check((0, _util.stringToBytes)(header, options?.encoding), options);
  }
  ...
  detectConfident = async (tokenizer) => {
    ...
    if (this.check([0x1F, 0x8B, 0x8])) {
      const gzipHandler = new _inflate.GzipHandler(tokenizer);
    ...
    if (this.check([0x50, 0x4B, 0x3, 0x4])) {// Local file header signature
      let fileType;
      await new _inflate.ZipHandler(tokenizer).unzip((zipHeader) => {
    ...
    this.check([0, 0, 0, 0, 0, 0], { offset: 257 }) && (0, _util.tarHeaderChecksumMatches)(this.buffer)) {
      return {
        ext: 'tar',
...
const supportedMimeTypes = exports.supportedMimeTypes = new Set(_supported.mimeTypes); /* v9-8bb4d8d57df85787 */
