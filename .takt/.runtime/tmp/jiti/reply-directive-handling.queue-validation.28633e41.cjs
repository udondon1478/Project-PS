"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.maybeHandleQueueDirective = maybeHandleQueueDirective;var _directiveHandlingShared = require("./directive-handling.shared.js");
...
function maybeHandleQueueDirective(params) {
  ...
  if (wantsStatus) {
    const settings = (0, _queue.resolveQueueSettings)({
      cfg: params.cfg,
    ...
    return {
      text: (0, _directiveHandlingShared.withOptions)(`Current queue settings: mode=${settings.mode}, debounce=${debounceLabel}, cap=${capLabel}, drop=${dropLabel}.`, "modes steer, followup, collect, steer+backlog, interrupt; debounce:<ms|s|m>, cap:<n>, drop:old|new|summarize")
    };
  }
