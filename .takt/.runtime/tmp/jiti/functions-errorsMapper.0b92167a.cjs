"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.errorMapper = void 0;const errorMapper = (data) => {
  const result = [];
  ...
  return result;
};exports.errorMapper = errorMapper; /* v9-1db4728c8739bc44 */
