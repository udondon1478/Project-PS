"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.isWhatsAppGroupJid = isWhatsAppGroupJid;exports.isWhatsAppUserTarget = isWhatsAppUserTarget;exports.normalizeWhatsAppTarget = normalizeWhatsAppTarget;var _utils = require("../utils.js");
...
function normalizeWhatsAppTarget(value) {
  ...
  if (isWhatsAppUserTarget(candidate)) {
    ...
    const normalized = (0, _utils.normalizeE164)(phone);
  ...
  const normalized = (0, _utils.normalizeE164)(candidate);
  return normalized.length > 1 ? normalized : null;
} /* v9-f735d90b24e9e763 */
