"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.formatAgentEnvelope = formatAgentEnvelope;exports.formatInboundEnvelope = formatInboundEnvelope;exports.formatInboundFromLabel = formatInboundFromLabel;exports.formatThreadStarterEnvelope = formatThreadStarterEnvelope;exports.formatZonedTimestamp = formatZonedTimestamp;exports.resolveEnvelopeFormatOptions = resolveEnvelopeFormatOptions;var _dateTime = require("../agents/date-time.js");
...
function resolveEnvelopeTimezone(options) {
  ...
  if (lowered === "user") {
    return { mode: "iana", timeZone: (0, _dateTime.resolveUserTimezone)(options.userTimezone) };
  }
...
function formatInboundEnvelope(params) {
  const chatType = (0, _chatType.normalizeChatType)(params.chatType);
  const isDirect = !chatType || chatType === "direct";
  const resolvedSender = params.senderLabel?.trim() || (0, _senderLabel.resolveSenderLabel)(params.sender ?? {});
