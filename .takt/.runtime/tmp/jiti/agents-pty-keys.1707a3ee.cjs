"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.BRACKETED_PASTE_START = exports.BRACKETED_PASTE_END = void 0;exports.encodeKeySequence = encodeKeySequence;exports.encodePaste = encodePaste;const ESC = "\x1b";
const CR = "\r";
const TAB = "\t";
const BACKSPACE = "\x7f";
const BRACKETED_PASTE_START = exports.BRACKETED_PASTE_START = `${ESC}[200~`;
const BRACKETED_PASTE_END = exports.BRACKETED_PASTE_END = `${ESC}[201~`;
