"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.getGitHubCopilotBaseUrl = getGitHubCopilotBaseUrl;exports.githubCopilotOAuthProvider = void 0;exports.loginGitHubCopilot = loginGitHubCopilot;exports.normalizeDomain = normalizeDomain;exports.refreshGitHubCopilotToken = refreshGitHubCopilotToken;


var _models = require("../../models.js"); /**
 * GitHub Copilot OAuth flow
 */const decode = (s) => atob(s);const CLIENT_ID = decode("SXYxLmI1MDdhMDhjODdlY2ZlOTg=");
...
async function enableAllGitHubCopilotModels(token, enterpriseDomain, onProgress) {
  const models = (0, _models.getModels)("github-copilot");
...
const githubCopilotOAuthProvider = exports.githubCopilotOAuthProvider = {
  id: "github-copilot",
  name: "GitHub Copilot",
