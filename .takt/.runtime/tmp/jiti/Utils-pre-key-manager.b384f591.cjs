"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.PreKeyManager = void 0;var _pQueue = _interopRequireDefault(require("p-queue"));function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}
/**
...
class PreKeyManager {
  ...
  getQueue(keyType) {
    if (!this.queues.has(keyType)) {
      this.queues.set(keyType, new _pQueue.default({ concurrency: 1 }));
    }
...
}exports.PreKeyManager = PreKeyManager; /* v9-6922999f022a6ec1 */
