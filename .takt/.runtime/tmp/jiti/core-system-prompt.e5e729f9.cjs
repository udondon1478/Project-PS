"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.buildSystemPrompt = buildSystemPrompt;


var _config = require("../config.js");
var _skills = require("./skills.js"); /**
 * System prompt construction and project context loading
 */ /** Tool descriptions for system prompt */const toolDescriptions = {
...
function buildSystemPrompt(options = {}) {
  ...
  if (customPrompt) {
    ...
    if (customPromptHasRead && skills.length > 0) {
      prompt += (0, _skills.formatSkillsForPrompt)(skills);
    }
  ...
  const readmePath = (0, _config.getReadmePath)();
  const docsPath = (0, _config.getDocsPath)();
  const examplesPath = (0, _config.getExamplesPath)();
