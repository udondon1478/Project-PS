"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.GuildThreadOnlyChannel = void 0;var _v = require("discord-api-types/v10");
var _GuildThreadChannel = require("../structures/GuildThreadChannel.js");
var _BaseGuildChannel = require("./BaseGuildChannel.js");
class GuildThreadOnlyChannel extends _BaseGuildChannel.BaseGuildChannel {
  /**
  ...
  async sendToPost(message, postId) {
    const channel = new _GuildThreadChannel.GuildThreadChannel(this.client, postId);
    return await channel.send(message);
  }
  async createPost(name, message, options) {
    const response = await this.client.rest.post(_v.Routes.threads(this.id), {
      body: {
        name,
        message,
    ...
    return new _GuildThreadChannel.GuildThreadChannel(this.client, response);
  }
}exports.GuildThreadOnlyChannel = GuildThreadOnlyChannel; /* v9-28f7f77fe8e9504a */
