"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.getChatCommands = getChatCommands;exports.getNativeCommandSurfaces = getNativeCommandSurfaces;var _dock = require("../channels/dock.js");
var _runtime = require("../plugins/runtime.js");
var _commandsArgs = require("./commands-args.js");
...
function buildChatCommands() {
  ...
  defineChatCommand({
    ...
    argsParsing: "none",
    formatArgs: _commandsArgs.COMMAND_ARG_FORMATTERS.config
  }),
  defineChatCommand({
    key: "debug",
    nativeName: "debug",
    ...
    argsParsing: "none",
    formatArgs: _commandsArgs.COMMAND_ARG_FORMATTERS.debug
  }),
  defineChatCommand({
    key: "usage",
    nativeName: "usage",
  ...
  defineChatCommand({
    ...
    args: [
    {
      ...
      type: "string",
      choices: ({ provider, model }) => (0, _thinking.listThinkingLevels)(provider, model)
    }],
  ...
  defineChatCommand({
    ...
    argsParsing: "none",
    formatArgs: _commandsArgs.COMMAND_ARG_FORMATTERS.queue
  }),
  defineChatCommand({
    key: "bash",
...
function getNativeCommandSurfaces() {
  ...
  cachedNativeCommandSurfaces = new Set((0, _dock.listChannelDocks)().
  filter((dock) => dock.capabilities.nativeCommands).
  map((dock) => dock.id));
