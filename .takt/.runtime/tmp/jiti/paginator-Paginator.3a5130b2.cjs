"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.Paginator = void 0;var _v = require("discord-api-types/v10");
var _Button = require("../../classes/components/Button.js");
var _Row = require("../../classes/components/Row.js");
...
class Paginator {
  ...
  createNavigationButtons(disabled = false) {
    ...
    return new _Row.Row([backButton, pageNumber, nextButton]);
  }
...
class DirectionButton extends _Button.Button {
  label;
  customId;
...
class PageNumberButton extends _Button.Button {
  label;
  customId;
  style = _v.ButtonStyle.Secondary;
  disabled;
  ...
  async run(interaction, data) {
    ...
    if (paginator.userId && paginator.userId !== interaction.user?.id)
    return interaction.acknowledge();
    const modal = new _GoToPageModal.GoToPageModal(paginatorId, maxPages);
