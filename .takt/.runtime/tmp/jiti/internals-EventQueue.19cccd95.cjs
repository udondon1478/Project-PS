"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.EventQueue = void 0;class EventQueue {
  client;
  queue = [];
  processing = 0;
  options;
...
}exports.EventQueue = EventQueue; /* v9-5d3ce20489088dad */
