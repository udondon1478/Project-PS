"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.NO_MESSAGE_FOUND_ERROR_TEXT = exports.NACK_REASONS = exports.MISSING_KEYS_ERROR_TEXT = exports.DECRYPTION_RETRY_CONFIG = void 0;exports.decodeMessageNode = decodeMessageNode;exports.getDecryptionJid = exports.extractAddressingContext = exports.decryptMessageNode = void 0;var _boom = require("@hapi/boom");
...
function decodeMessageNode(stanza, meId, meLid) {
  ...
  if ((0, _index2.isPnUser)(from) || (0, _index2.isLidUser)(from) || (0, _index2.isHostedLidUser)(from) || (0, _index2.isHostedPnUser)(from)) {
    if (recipient && !(0, _index2.isJidMetaAI)(recipient)) {
      if (!isMe(from) && !isMeLid(from)) {
        throw new _boom.Boom('receipient present, but msg not from me', { data: stanza });
      }
      if (isMe(from) || isMeLid(from)) {
        fromMe = true;
      }
  ...
  if ((0, _index2.isJidBroadcast)(from)) {
    if (!participant) {
      throw new _boom.Boom('No participant in group message');
    }
  ...
  if ((0, _index2.isJidNewsletter)(from)) {
    msgType = 'newsletter';
    chatId = from;
    author = from;
    if (isMe(from) || isMeLid(from)) {
  ...
  {
    throw new _boom.Boom('Unknown message type', { data: stanza });
  }
