"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.extensionForImageMimeType = extensionForImageMimeType;exports.isWaylandSession = isWaylandSession;exports.readClipboardImage = readClipboardImage;var _child_process = require("child_process");
...
async function readClipboardImage(options) {
  ...
  {
    if (!_clipboardNative.clipboard || !_clipboardNative.clipboard.hasImage()) {
      return null;
    }
    const imageData = await _clipboardNative.clipboard.getImageBinary();
