"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.LT_HASH_ANTI_TAMPERING = void 0;var _crypto = require("./crypto.js");
/**
...
class LTHash {
  ...
  async _addSingle(e, t) {
    const derived = new Uint8Array(await (0, _crypto.hkdf)(Buffer.from(t), o, { info: this.salt })).buffer;
...
const LT_HASH_ANTI_TAMPERING = exports.LT_HASH_ANTI_TAMPERING = new LTHash('WhatsApp Patch Integrity'); /* v9-2042f9601d2ac07a */
