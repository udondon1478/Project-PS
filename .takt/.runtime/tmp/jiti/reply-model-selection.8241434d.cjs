"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.createModelSelectionState = createModelSelectionState;exports.resolveContextTokens = resolveContextTokens;exports.resolveModelDirectiveSelection = resolveModelDirectiveSelection;var _sessionOverride = require("../../agents/auth-profiles/session-override.js");
...
var _sessionKeyUtils = require("../../sessions/session-key-utils.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
...
function resolveParentSessionKeyCandidate(params) {
  ...
  const derived = (0, _sessionKeyUtils.resolveThreadParentSessionKey)(params.sessionKey);
...
function scoreFuzzyMatch(params) {
  ...
  const key = (0, _modelSelection.modelKey)(provider, model);
  ...
  const defaultProvider = (0, _modelSelection.normalizeProviderId)(params.defaultProvider);
...
async function createModelSelectionState(params) {
  ...
  if (needsModelCatalog) {
    modelCatalog = await (0, _modelCatalog.loadModelCatalog)({ config: cfg });
  ...
  if (sessionEntry && sessionStore && sessionKey && hasStoredOverride) {
    ...
    if (overrideModel) {
      const key = (0, _modelSelection.modelKey)(overrideProvider, overrideModel);
  ...
  if (storedOverride?.model) {
    ...
    const key = (0, _modelSelection.modelKey)(candidateProvider, storedOverride.model);
    if (allowedModelKeys.size === 0 || allowedModelKeys.has(key)) {
  ...
  if (sessionEntry && sessionStore && sessionKey && sessionEntry.authProfileOverride) {
    const { ensureAuthProfileStore } = await Promise.resolve().then(() => jitiImport("../../agents/auth-profiles.js").then((m) => _interopRequireWildcard(m)));
    ...
    if (!profile || (0, _modelSelection.normalizeProviderId)(profile.provider) !== providerKey) {
      await (0, _sessionOverride.clearSessionAuthProfileOverride)({
        sessionEntry,
        sessionStore,
        sessionKey,
        storePath
  ...
  const resolveDefaultThinkingLevel = async () => {
    ...
    const resolved = (0, _modelSelection.resolveThinkingDefault)({
      cfg,
      provider,
      model,
...
function resolveModelDirectiveSelection(params) {
  ...
  const pickAliasForKey = (provider, model) => aliasIndex.byKey.get((0, _modelSelection.modelKey)(provider, model))?.[0];
  ...
  const resolveFuzzy = (params) => {
    ...
    const providerFilter = params.provider ? (0, _modelSelection.normalizeProviderId)(params.provider) : undefined;
    const candidates = [];
    for (const key of allowedModelKeys) {
      ...
      const provider = (0, _modelSelection.normalizeProviderId)(key.slice(0, slash));
    ...
    if (!params.provider) {
      ...
      for (const match of aliasMatches) {
        const key = (0, _modelSelection.modelKey)(match.provider, match.model);
  ...
  const resolvedKey = (0, _modelSelection.modelKey)(resolved.ref.provider, resolved.ref.model);
  ...
  if (rawLower.includes("/")) {
    ...
    const provider = (0, _modelSelection.normalizeProviderId)(rawTrimmed.slice(0, slash).trim());
...
function resolveContextTokens(params) {
  return params.agentCfg?.contextTokens ?? (0, _context.lookupContextTokens)(params.model) ?? _defaults.DEFAULT_CONTEXT_TOKENS;
} /* v9-117f6994a1b92e24 */
