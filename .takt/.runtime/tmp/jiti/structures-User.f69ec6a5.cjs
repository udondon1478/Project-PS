"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.User = void 0;var _v = require("discord-api-types/v10");
var _Base = require("../abstracts/Base.js");
var _index = require("../utils/index.js");
var _Message = require("./Message.js");
class User extends _Base.Base {
   ...
   */
  async fetch() {
    const newData = await this.client.rest.get(_v.Routes.user(this.id));
    if (!newData)
   ...
   */
  async createDm() {
    const dmChannel = await this.client.rest.post(_v.Routes.userChannels(), {
      body: {
  ...
  async send(data) {
    ...
    const message = await this.client.rest.post(_v.Routes.channelMessages(dmChannel.id), {
      body: (0, _index.serializePayload)(data)
    });
    return new _Message.Message(this.client, message);
  }
}exports.User = User; /* v9-a04f689d531d329f */
