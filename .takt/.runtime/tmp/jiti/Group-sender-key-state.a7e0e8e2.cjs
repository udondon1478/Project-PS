"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.SenderKeyState = void 0;var _senderChainKey = require("./sender-chain-key.js");
...
class SenderKeyState {
  ...
  getSenderChainKey() {
    return new _senderChainKey.SenderChainKey(this.senderKeyStateStructure.senderChainKey.iteration, this.senderKeyStateStructure.senderChainKey.seed);
  }
  ...
  removeSenderMessageKey(iteration) {
    ...
    if (index !== -1) {
      ...
      return new _senderMessageKey.SenderMessageKey(messageKey.iteration, messageKey.seed);
    }
    return null;
  }
  getStructure() {
...
}exports.SenderKeyState = SenderKeyState; /* v9-26118d0a846833c1 */
