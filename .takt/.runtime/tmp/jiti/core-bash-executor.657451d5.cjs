"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.executeBash = executeBash;exports.executeBashWithOperations = executeBashWithOperations;
 ...
 */function executeBash(command, options) {return new Promise((resolve, reject) => {const { shell, args } = (0, _shell.getShellConfig)();const child = (0, _child_process.spawn)(shell, [...args, command], { detached: true,
          env: (0, _shell.getShellEnv)(),
      ...
      const handleData = (data) => {
        ...
        if (totalBytes > _truncate.DEFAULT_MAX_BYTES && !tempFilePath) {
