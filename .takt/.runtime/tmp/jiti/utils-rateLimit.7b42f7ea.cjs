"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.GatewayRateLimit = void 0;class GatewayRateLimit {
  events = [];
  config;
...
}exports.GatewayRateLimit = GatewayRateLimit; /* v9-ecfdddc26d44e341 */
