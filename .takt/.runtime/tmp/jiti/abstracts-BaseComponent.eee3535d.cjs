"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.BaseComponent = void 0;class BaseComponent {
  /**
   ...
   */
  id;
}exports.BaseComponent = BaseComponent; /* v9-53647dd5e88add7e */
