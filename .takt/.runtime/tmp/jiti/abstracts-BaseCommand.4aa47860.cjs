"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.BaseCommand = void 0;var _v = require("discord-api-types/v10");
...
class BaseCommand {
   ...
   */
  integrationTypes = [
  _index.ApplicationIntegrationType.GuildInstall,
  _index.ApplicationIntegrationType.UserInstall];

  /**
   * The contexts this command can be used in
   */
  contexts = [
  _index.InteractionContextType.Guild,
  _index.InteractionContextType.BotDM,
  _index.InteractionContextType.PrivateChannel];
...
}exports.BaseCommand = BaseCommand; /* v9-b820a79cd3856fac */
