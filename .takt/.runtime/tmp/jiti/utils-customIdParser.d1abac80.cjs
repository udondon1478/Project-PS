"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.parseCustomId = void 0;const parseCustomId = (id) => {
...
};exports.parseCustomId = parseCustomId; /* v9-7280db1654d1a5d7 */
