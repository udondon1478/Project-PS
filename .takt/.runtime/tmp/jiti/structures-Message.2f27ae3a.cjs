"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.Message = void 0;var _v = require("discord-api-types/v10");
var _Base = require("../abstracts/Base.js");
var _Embed = require("../classes/Embed.js");
var _channelFactory = require("../functions/channelFactory.js");
var _index = require("../utils/index.js");
var _GuildThreadChannel = require("./GuildThreadChannel.js");
var _Poll = require("./Poll.js");
var _Role = require("./Role.js");
var _User = require("./User.js");
class Message extends _Base.Base {
  ...
  get embeds() {
    ...
    return [];
    return this._rawData.embeds.map((embed) => new _Embed.Embed(embed));
  }
  /**
  ...
  get mentionedUsers() {
    ...
    return [];
    return this._rawData.mentions.map((mention) => new _User.User(this.client, mention));
  }
  /**
  ...
  get mentionedRoles() {
    ...
    return [];
    return this._rawData.mention_roles.map((mention) => new _Role.Role(this.client, mention));
  }
  /**
  ...
  get poll() {
    ...
    return undefined;
    return new _Poll.Poll(this.client, {
  ...
  get author() {
    ...
    return new _User.User(this.client, this._rawData.author);
  }
  /**
  ...
  get thread() {
    ...
    return null;
    return (0, _channelFactory.channelFactory)(this.client, this._rawData?.thread);
  }
  /**
  ...
  async fetch() {
    ...
    const newData = await this.client.rest.get(_v.Routes.channelMessage(this.channelId, this.id));
    if (!newData)
  ...
  async delete() {
    ...
    await this.client.rest.delete(_v.Routes.channelMessage(this.channelId, this.id));
  }
  /**
  ...
  async fetchChannel() {
    ...
    const data = await this.client.rest.get(_v.Routes.channel(this.channelId));
    const channel = (0, _channelFactory.channelFactory)(this.client, data);
    return channel;
  }
  /**
   * Pin this message
  ...
  async pin() {
    ...
    await this.client.rest.put(_v.Routes.channelMessagesPin(this.channelId, this.id));
  }
  /**
   * Unpin this message
   */
  async unpin() {
    ...
    await this.client.rest.delete(_v.Routes.channelMessagesPin(this.channelId, this.id));
  }
  /**
  ...
  async startThread(data) {
    ...
    const thread = await this.client.rest.post(_v.Routes.threads(this.channelId, this.id), {
      body: { ...data }
    });
    return new _GuildThreadChannel.GuildThreadChannel(this.client, thread);
  }
  /**
   * Edit this message
  ...
  async edit(data) {
    ...
    const newMessage = await this.client.rest.patch(_v.Routes.channelMessage(this.channelId, this.id), {
      body: {
        ...serialized
      }
    });
  ...
  async forward(channelId) {
    ...
    const message = await this.client.rest.post(_v.Routes.channelMessages(channelId), {
      body: {
        message_reference: {
          type: _v.MessageReferenceType.Forward,
          message_id: this.id,
  ...
  async reply(data) {
    ...
    const serialized = (0, _index.serializePayload)(data);
    const message = await this.client.rest.post(_v.Routes.channelMessages(this.channelId), {
      body: {
        ...serialized,
        message_reference: {
          type: _v.MessageReferenceType.Default,
          message_id: this.id
        }
      }
    });
  ...
  async disableAllButtons() {
    ...
    return;
    const patched = await this.client.rest.patch(_v.Routes.channelMessage(this.channelId, this.id), {
      body: {
        ...this._rawData,
        components: this._rawData.components?.map((component) => {
          const disable = (component) => {
            if (component.type === _v.ComponentType.ActionRow) {
              return {
                ...component,
            ...
            if (component.type === _v.ComponentType.Section) {
              return {
                ...component,
          ...
          if (component.type === _v.ComponentType.Container) {
            return {
              ...component,
...
}exports.Message = Message; /* v9-a06d1417305e39e8 */
