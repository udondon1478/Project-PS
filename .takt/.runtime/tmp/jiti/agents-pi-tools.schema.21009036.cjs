"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.cleanToolSchemaForGemini = cleanToolSchemaForGemini;exports.normalizeToolParameters = normalizeToolParameters;var _cleanForGemini = require("./schema/clean-for-gemini.js");
...
function normalizeToolParameters(tool) {
  ...
  if ("type" in schema && "properties" in schema && !Array.isArray(schema.anyOf)) {
    return {
      ...tool,
      parameters: (0, _cleanForGemini.cleanSchemaForGemini)(schema)
    };
  }
  ...
  !Array.isArray(schema.oneOf)) {
    return {
      ...tool,
      parameters: (0, _cleanForGemini.cleanSchemaForGemini)({ ...schema, type: "object" })
    };
  }
  ...
  return {
    ...
    parameters: (0, _cleanForGemini.cleanSchemaForGemini)({
      type: "object",
...
function cleanToolSchemaForGemini(schema) {
  return (0, _cleanForGemini.cleanSchemaForGemini)(schema);
} /* v9-e24116868cb1bbfa */
