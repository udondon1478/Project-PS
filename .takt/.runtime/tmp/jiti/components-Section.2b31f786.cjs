"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.Section = void 0;var _v = require("discord-api-types/v10");
var _BaseComponent = require("../../abstracts/BaseComponent.js");
class Section extends _BaseComponent.BaseComponent {
  type = _v.ComponentType.Section;
  isV2 = true;
  /**
...
}exports.Section = Section; /* v9-1094b17c3d5aaac1 */
