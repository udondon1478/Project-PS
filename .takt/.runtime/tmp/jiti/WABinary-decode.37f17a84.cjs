"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.decompressingIfRequired = exports.decodeDecompressedBinaryNode = exports.decodeBinaryNode = void 0;var _util = require("util");
var _zlib = require("zlib");
var constants = _interopRequireWildcard(require("./constants.js"));
var _jidUtils = require("./jid-utils.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
...
const decodeDecompressedBinaryNode = (buffer, opts, indexRef = { index: 0 }) => {
  ...
  const readAdJid = () => {
    ...
    if (domainType === _jidUtils.WAJIDDomains.LID) {
      server = 'lid';
    } else
    if (domainType === _jidUtils.WAJIDDomains.HOSTED) {
      server = 'hosted';
    } else
    if (domainType === _jidUtils.WAJIDDomains.HOSTED_LID) {
      server = 'hosted.lid';
    }
    return (0, _jidUtils.jidEncode)(user, server, device);
  };
...
};exports.decodeBinaryNode = decodeBinaryNode; /* v9-ce1b8a3ca05aa24b */
