"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.filterAndSortSessions = filterAndSortSessions;exports.hasSessionName = hasSessionName;exports.matchSession = matchSession;exports.parseSearchQuery = parseSearchQuery;var _piTui = require("@mariozechner/pi-tui");
...
function matchSession(session, parsed) {
  ...
  for (const token of parsed.tokens) {
    ...
    const m = (0, _piTui.fuzzyMatch)(token.value, text);
    if (!m.matches)
    return { matches: false, score: 0 };
    totalScore += m.score;
  }
