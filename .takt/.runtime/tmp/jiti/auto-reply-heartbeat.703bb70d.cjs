"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.HEARTBEAT_PROMPT = exports.DEFAULT_HEARTBEAT_EVERY = exports.DEFAULT_HEARTBEAT_ACK_MAX_CHARS = void 0;exports.isHeartbeatContentEffectivelyEmpty = isHeartbeatContentEffectivelyEmpty;exports.resolveHeartbeatPrompt = resolveHeartbeatPrompt;exports.stripHeartbeatToken = stripHeartbeatToken;var _tokens = require("./tokens.js");
// Default heartbeat prompt (used when config.agents.defaults.heartbeat.prompt is unset).
// Keep it tight and avoid encouraging the model to invent/rehash "open loops" from prior chat context.
const HEARTBEAT_PROMPT = exports.HEARTBEAT_PROMPT = "Read HEARTBEAT.md if it exists (workspace context). Follow it strictly. Do not infer or repeat old tasks from prior chats. If nothing needs attention, reply HEARTBEAT_OK.";
const DEFAULT_HEARTBEAT_EVERY = exports.DEFAULT_HEARTBEAT_EVERY = "30m";
const DEFAULT_HEARTBEAT_ACK_MAX_CHARS = exports.DEFAULT_HEARTBEAT_ACK_MAX_CHARS = 300;
/**
...
function stripTokenAtEdges(raw) {
  ...
  const token = _tokens.HEARTBEAT_TOKEN;
...
function stripHeartbeatToken(raw, opts = {}) {
  ...
  const hasToken = trimmed.includes(_tokens.HEARTBEAT_TOKEN) || trimmedNormalized.includes(_tokens.HEARTBEAT_TOKEN);
  if (!hasToken) {
