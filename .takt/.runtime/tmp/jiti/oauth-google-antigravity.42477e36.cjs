"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.antigravityOAuthProvider = void 0;exports.loginAntigravity = loginAntigravity;exports.refreshAntigravityToken = refreshAntigravityToken;
...
const decode = (s) => atob(s);const CLIENT_ID = decode("MTA3MTAwNjA2MDU5MS10bWhzc2luMmgyMWxjcmUyMzV2dG9sb2poNGc0MDNlcC5hcHBzLmdvb2dsZXVzZXJjb250ZW50LmNvbQ==");const CLIENT_SECRET = decode("R09DU1BYLUs1OEZXUjQ4NkxkTEoxbUxCOHNYQzR6NnFEQWY=");const REDIRECT_URI = "http://localhost:51121/oauth-callback"; // Antigravity requires additional scopes
...
async function startCallbackServer() {
  const { createServer } = await Promise.resolve().then(() => jitiImport("http").then((m) => _interopRequireWildcard(m)));
...
const antigravityOAuthProvider = exports.antigravityOAuthProvider = {
