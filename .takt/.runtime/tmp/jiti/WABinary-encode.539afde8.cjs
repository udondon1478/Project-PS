"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.encodeBinaryNode = void 0;var constants = _interopRequireWildcard(require("./constants.js"));
...
const encodeBinaryNodeInner = ({ tag, attrs, content }, opts, buffer) => {
  ...
  const writeString = (str) => {
    ...
    if (str) {
      const decodedJid = (0, _jidUtils.jidDecode)(str);
      if (decodedJid) {
        writeJid(decodedJid);
      } else
      {
