"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.makeEventBuffer = void 0;var _events = _interopRequireDefault(require("events"));
var _index = require("../Types/index.js");
var _generics = require("./generics.js");
var _messages = require("./messages.js");
var _processMessage = require("./process-message.js");function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}
...
eventData, logger) {
  ...
  function decrementChatReadCounterIfMsgDidUnread(message) {
    ...
    if ((0, _processMessage.isRealMessage)(message) &&
    (0, _processMessage.shouldIncrementChatUnread)(message) &&
...
const stringifyMessageKey = (key) => `${key.remoteJid},${key.id},${key.fromMe ? '1' : '0'}`; /* v9-59d776f28ef2a322 */
