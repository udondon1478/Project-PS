"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.EditorKeybindingsManager = exports.DEFAULT_EDITOR_KEYBINDINGS = void 0;exports.getEditorKeybindings = getEditorKeybindings;exports.setEditorKeybindings = setEditorKeybindings;var _keys = require("./keys.js");
/**
 * Default editor keybindings.
 */
const DEFAULT_EDITOR_KEYBINDINGS = exports.DEFAULT_EDITOR_KEYBINDINGS = {
  // Cursor movement
  cursorUp: "up",
  cursorDown: "down",
...
class EditorKeybindingsManager {
  ...
  matches(data, action) {
    ...
    for (const key of keys) {
      if ((0, _keys.matchesKey)(data, key))
      return true;
    }
    return false;
  }
...
// Global instance
exports.EditorKeybindingsManager = EditorKeybindingsManager;let globalEditorKeybindings = null;
