"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.ThreadMember = void 0;var _Base = require("../abstracts/Base.js");
var _Guild = require("./Guild.js");
var _GuildMember = require("./GuildMember.js");
var _User = require("./User.js");
class ThreadMember extends _Base.Base {
  ...
  get user() {
    if (!this.userId)
    return undefined;
    return new _User.User(this.client, this.userId);
  }
  /**
  ...
  member(guildId) {
    ...
    return new _GuildMember.GuildMember(this.client, this._rawData.member, new _Guild.Guild(this.client, guildId));
  }
}exports.ThreadMember = ThreadMember; /* v9-3c6ac9b79ac47582 */
