"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.RpcClient = void 0;
...
// RPC Client
// ============================================================================
class RpcClient {options;process = null;rl = null;
  eventListeners = [];
  ...
  async start() {
    ...
    this.process = (0, _nodeChild_process.spawn)("node", [cliPath, ...args], {
...
}exports.RpcClient = RpcClient; /* v9-be62e7654da1b08e */
