"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.ModelSelectorComponent = void 0;var _piAi = require("@mariozechner/pi-ai");
...
class ModelSelectorComponent extends _piTui.Container {
  ...
  getScopeHintText() {
    return (0, _keybindingHints.keyHint)("tab", "scope") + _theme.theme.fg("muted", " (all/scoped)");
  }
  setScope(scope) {
    if (this.scope === scope)
    return;
  ...
  filterModels(query) {
    ...
    (0, _piTui.fuzzyFilter)(this.activeModels, query, ({ id, provider }) => `${id} ${provider}`) :
    this.activeModels;
    this.selectedIndex = Math.min(this.selectedIndex, Math.max(0, this.filteredModels.length - 1));
    this.updateList();
  }
...
}exports.ModelSelectorComponent = ModelSelectorComponent; /* v9-a525a807e9d7088b */
