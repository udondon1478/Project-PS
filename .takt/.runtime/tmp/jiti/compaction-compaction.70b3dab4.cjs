"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.DEFAULT_COMPACTION_SETTINGS = void 0;exports.calculateContextTokens = calculateContextTokens;exports.compact = compact;exports.estimateContextTokens = estimateContextTokens;exports.estimateTokens = estimateTokens;exports.findCutPoint = findCutPoint;exports.findTurnStartIndex = findTurnStartIndex;exports.generateSummary = generateSummary;exports.getLastAssistantUsage = getLastAssistantUsage;exports.prepareCompaction = prepareCompaction;exports.shouldCompact = shouldCompact;
 ...
 */function extractFileOperations(messages, entries, prevCompactionIndex) {const fileOps = (0, _utils.createFileOps)(); // Collect from previous compaction's details (if pi-generated)
  if (prevCompactionIndex >= 0) {const prevCompaction = entries[prevCompactionIndex];
  ...
  for (const msg of messages) {
    (0, _utils.extractFileOpsFromMessage)(msg, fileOps);
  }
  return fileOps;
}
// ============================================================================
...
const DEFAULT_COMPACTION_SETTINGS = exports.DEFAULT_COMPACTION_SETTINGS = {
  enabled: true,
  reserveTokens: 16384,
 ...
 */
async function generateSummary(currentMessages, model, reserveTokens, apiKey, signal, customInstructions, previousSummary) {
  ...
  const llmMessages = (0, _messages.convertToLlm)(currentMessages);
  ...
  const response = await (0, _piAi.completeSimple)(model, { systemPrompt: _utils.SUMMARIZATION_SYSTEM_PROMPT, messages: summarizationMessages }, { maxTokens, signal, apiKey, reasoning: "high" });
...
async function generateTurnPrefixSummary(messages, model, reserveTokens, apiKey, signal) {
  ...
  const response = await (0, _piAi.completeSimple)(model, { systemPrompt: _utils.SUMMARIZATION_SYSTEM_PROMPT, messages: summarizationMessages }, { maxTokens, signal, apiKey });
  if (response.stopReason === "error") {
