"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.ArminComponent = void 0;


var _theme = require("../theme/theme.js"); /**
 * Armin says hi! A fun easter egg with animated XBM art.
 */ // XBM image: 31x36 pixels, LSB first, 1=background, 0=foreground
const WIDTH = 31;const HEIGHT = 36;
const BITS = [
...
class ArminComponent {
  ...
  render(width) {
    ...
    this.cachedLines = this.currentGrid.map((row) => {
      ...
      return ` ${_theme.theme.fg("accent", clipped)}${" ".repeat(padRight)}`;
    });
    // Add "ARMIN SAYS HI" at the end
    const message = "ARMIN SAYS HI";
    const msgPadRight = Math.max(0, width - padding - message.length);
    this.cachedLines.push(` ${_theme.theme.fg("accent", message)}${" ".repeat(msgPadRight)}`);
...
}exports.ArminComponent = ArminComponent; /* v9-fef8601cf67164db */
