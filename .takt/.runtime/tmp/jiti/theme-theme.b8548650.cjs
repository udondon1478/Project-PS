...
var _config = require("../../../config.js");function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
// ============================================================================
// Types & Schema
// ============================================================================
const ColorValueSchema = _typebox.Type.Union([
_typebox.Type.String(), // hex "#ff0000", var ref "primary", or empty ""
_typebox.Type.Integer({ minimum: 0, maximum: 255 }) // 256-color index
]);
const ThemeJsonSchema = _typebox.Type.Object({
  $schema: _typebox.Type.Optional(_typebox.Type.String()),
  name: _typebox.Type.String(),
  vars: _typebox.Type.Optional(_typebox.Type.Record(_typebox.Type.String(), ColorValueSchema)),
  colors: _typebox.Type.Object({
    // Core UI (10 colors)
  ...
  export: _typebox.Type.Optional(_typebox.Type.Object({
    pageBg: _typebox.Type.Optional(ColorValueSchema),
    cardBg: _typebox.Type.Optional(ColorValueSchema),
    infoBg: _typebox.Type.Optional(ColorValueSchema)
  }))
});
const validateThemeJson = _compiler.TypeCompiler.Compile(ThemeJsonSchema);
// ============================================================================
// Color Utilities
// ============================================================================
...
class Theme {
  ...
  italic(text) {
    return _chalk.default.italic(text);
  }
  underline(text) {
    return _chalk.default.underline(text);
  }
  inverse(text) {
    return _chalk.default.inverse(text);
  }
  strikethrough(text) {
    return _chalk.default.strikethrough(text);
  }
  getFgAnsi(color) {
    const ansi = this.fgColors.get(color);
    if (!ansi)
...
// Theme Loading
// ============================================================================
exports.Theme = Theme;let BUILTIN_THEMES;
function getBuiltinThemes() {
  if (!BUILTIN_THEMES) {
    const themesDir = (0, _config.getThemesDir)();
...
function getAvailableThemes() {
  ...
  const customThemesDir = (0, _config.getCustomThemesDir)();
...
const theme = exports.theme = new Proxy({}, {
  get(_target, prop) {
...
function highlightCode(code, lang) {
  ...
  const validLang = lang && (0, _cliHighlight.supportsLanguage)(lang) ? lang : undefined;
  const opts = {
    language: validLang,
    ignoreIllegals: true,
  ...
  try {
    return (0, _cliHighlight.highlight)(code, opts).split("\n");
  }
  catch {
    return code.split("\n");
  }
