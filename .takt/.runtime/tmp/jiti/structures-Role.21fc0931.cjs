"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.Role = void 0;var _v = require("discord-api-types/v10");
var _Base = require("../abstracts/Base.js");
var _index = require("../utils/index.js");
var _Guild = require("./Guild.js");
class Role extends _Base.Base {
  ...
  get rawData() {
    if (!this._rawData)
    throw new Error("Cannot access rawData on partial Role. Use fetch() to populate data.");
  ...
  get iconUrl() {
    if (!this._rawData)
    return undefined;
    return (0, _index.buildCDNUrl)(`https://cdn.discordapp.com/role-icons/${this.id}`, this.icon);
  }
  /**
  ...
  getIconUrl(options) {
    if (!this._rawData)
    return undefined;
    return (0, _index.buildCDNUrl)(`https://cdn.discordapp.com/role-icons/${this.id}`, this.icon, options);
  }
  /**
   ...
   */
  async fetch() {
    const newData = await this.client.rest.get(_v.Routes.guildRole(this.guildId, this.id));
    if (!newData)
  ...
  async setName(name, reason) {
    await this.client.rest.patch(_v.Routes.guildRole(this.guildId, this.id), {
      body: { name },
   ...
   */
  async delete(reason) {
    await this.client.rest.delete(_v.Routes.guildRole(this.guildId, this.id), {
      headers: reason ? { "X-Audit-Log-Reason": reason } : undefined
    });
  }
  /**
...
}exports.Role = Role; /* v9-ab4e0dc351492645 */
