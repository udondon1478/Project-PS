"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.ClientManager = void 0;var _v = require("discord-api-types/v10");
...
class ClientManager {
  ...
  async setupClient(credentials, options = {
    ...
    const client = new _Client.Client(clientOptions, this.initialHandlers, this.initialPlugins);
    this.clients.set(credentials.clientId, client);
    if (options.setInteractionsUrlOnDevPortal ||
    options.setEventsUrlOnDevPortal) {
      await client.rest.patch(_v.Routes.currentApplication(), {
        body: {
...
}exports.ClientManager = ClientManager; /* v9-a26a923a320d5f9f */
