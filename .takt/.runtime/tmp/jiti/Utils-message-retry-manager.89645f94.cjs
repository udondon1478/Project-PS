"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.MessageRetryManager = void 0;var _lruCache = require("lru-cache");
...
class MessageRetryManager {
  constructor(logger, maxMsgRetryCount) {
    this.logger = logger;
    this.recentMessagesMap = new _lruCache.LRUCache({
    ...
    this.sessionRecreateHistory = new _lruCache.LRUCache({
      ttl: RECREATE_SESSION_TIMEOUT * 2,
      ttlAutopurge: true
    });
    this.retryCounters = new _lruCache.LRUCache({
      ttl: 15 * 60 * 1000,
      ttlAutopurge: true,
      updateAgeOnGet: true
    }); // 15 minutes TTL
...
}exports.MessageRetryManager = MessageRetryManager; /* v9-63e130dc99a0d349 */
