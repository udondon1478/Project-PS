"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.GuildThreadChannel = void 0;var _v = require("discord-api-types/v10");
var _BaseGuildChannel = require("../abstracts/BaseGuildChannel.js");
class GuildThreadChannel extends _BaseGuildChannel.BaseGuildChannel {
  /**
  ...
  async addMember(userId) {
    await this.client.rest.put(_v.Routes.threadMembers(this.id, userId));
  }
  /**
   * Leave the thread
   */
  ...
  async removeMember(userId) {
    await this.client.rest.delete(_v.Routes.threadMembers(this.id, userId));
  }
  /**
   * Archive the thread
   */
   ...
   */
  async lock() {
    await this.client.rest.put(_v.Routes.channel(this.id), {
      body: { locked: true }
    });
...
}exports.GuildThreadChannel = GuildThreadChannel; /* v9-692bdcbb0a90f453 */
