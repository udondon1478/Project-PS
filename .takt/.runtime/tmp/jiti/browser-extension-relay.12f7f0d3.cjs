"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.ensureChromeExtensionRelayServer = ensureChromeExtensionRelayServer;exports.getChromeExtensionRelayAuthHeaders = getChromeExtensionRelayAuthHeaders;exports.stopChromeExtensionRelayServer = stopChromeExtensionRelayServer;var _nodeCrypto = require("node:crypto");
var _nodeHttp = require("node:http");
var _ws = _interopRequireWildcard(require("ws"));
var _ws2 = require("../infra/ws.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
...
async function ensureChromeExtensionRelayServer(opts) {
  ...
  const relayAuthToken = (0, _nodeCrypto.randomBytes)(32).toString("base64url");
  ...
  const wssExtension = new _ws.WebSocketServer({ noServer: true });
  const wssCdp = new _ws.WebSocketServer({ noServer: true });
  ...
  wssExtension.on("connection", (ws) => {
    ...
    ws.on("message", (data) => {
      let parsed = null;
      try {
        parsed = JSON.parse((0, _ws2.rawDataToString)(data));
      }
      catch {
        return;
      }
  ...
  wssCdp.on("connection", (ws) => {
    ...
    ws.on("message", async (data) => {
      let cmd = null;
      try {
        cmd = JSON.parse((0, _ws2.rawDataToString)(data));
      }
      catch {
        return;
      }
