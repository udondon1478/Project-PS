"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.BaseMessageInteractiveComponent = void 0;var _customIdParser = require("../utils/customIdParser.js");
var _BaseComponent = require("./BaseComponent.js");
class BaseMessageInteractiveComponent extends _BaseComponent.BaseComponent {
  isV2 = false;
  /**
   ...
   */
  customIdParser = _customIdParser.parseCustomId;
...
}exports.BaseMessageInteractiveComponent = BaseMessageInteractiveComponent; /* v9-a70ff1988ef39e4a */
