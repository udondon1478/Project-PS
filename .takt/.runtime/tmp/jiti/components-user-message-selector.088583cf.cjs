"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.UserMessageSelectorComponent = void 0;var _piTui = require("@mariozechner/pi-tui");
...
class UserMessageSelectorComponent extends _piTui.Container {
  ...
  constructor(messages, onSelect, onCancel) {
    ...
    this.addChild(new _piTui.Text(_theme.theme.bold("Branch from Message"), 1, 0));
    this.addChild(new _piTui.Text(_theme.theme.fg("muted", "Select a message to create a new branch from that point"), 1, 0));
    this.addChild(new _piTui.Spacer(1));
...
}exports.UserMessageSelectorComponent = UserMessageSelectorComponent; /* v9-c05496b36e0fcd56 */
