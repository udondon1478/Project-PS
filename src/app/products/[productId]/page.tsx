...
import { TagDetailModal } from '@/components/TagDetailModal'; // Import the new modal
...
const ProductDetailPage = () => {
  ...
  // State for the new Tag Detail Modal
  ...
  // Handler for opening the new detail modal
                            ...
                            <div className="flex items-center gap-1 flex-shrink-0">
                              ...
                              <Tooltip>
                                <TooltipTrigger asChild>
                                  <Button variant="ghost" size="icon" className="h-7 w-7 text-blue-500 hover:text-blue-700 hover:bg-blue-100 dark:hover:bg-blue-900/50" onClick={() => handleViewTagDetails(tag.id)}>
                                    <Info size={16} />
                                  </Button>
                                </TooltipTrigger>
                                <TooltipContent>
