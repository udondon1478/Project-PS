  ...
  return (
    <div className="container mx-auto p-8 prose dark:prose-invert max-w-3xl">
      ...
      <ul className="list-disc pl-6 mb-4">
        <li>1. 商品の閲覧履歴（アクセスログ、IPアドレス、User Agent等）</li>
        <li>2. 商品への「いいね」や「所有済み」登録情報</li>
        <li>3. 商品登録情報およびタグ編集履歴</li>
      </ul>
      ...
      <ul className="list-disc pl-6 mb-4">
        <li>1. 本サービスの提供・運営のため（ログイン認証、マイページ機能の提供など）</li>
        <li>2. ユーザー設定（タグ表示設定、言語設定等）を保存・適用するため</li>
        <li>3. ユーザーが利用規約に違反する行為を行った場合に、当該ユーザーを特定し対応するため</li>
        <li>4. 本サービスの利用状況を分析し、機能改善や新サービスの開発に役立てるため</li>
        <li>5. スパム行為や不正アクセスを検知・防止するため</li>
